...
// const socket = io.connect('${process.env.REACT_APP_API_URL || "http://localhost:5500"}');
// const ChatRoom = () => {
...
//       try {
//         console.log(userId);
//         const response = await axios.get(`${process.env.REACT_APP_API_URL || "http://localhost:5500"}/api/collab/collabs/${userId}`);
...
//       const response = await axios.get(`${process.env.REACT_APP_API_URL || "http://localhost:5500"}/api/collab/chat/${projectId}`);
...
//     await axios.post(`${process.env.REACT_APP_API_URL || "http://localhost:5500"}/api/collab/chat/${selectedProject}`,  newMessage );
